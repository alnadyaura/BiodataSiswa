package com.example.biodatasiswa.adapter;
...
import com.example.biodatasiswa.activities.ListSiswaActivity;
import com.example.biodatasiswa.activities.UpdateKelasActivity;
                    ...
                    public boolean onMenuItemClick(MenuItem menuItem) {
                        switch (menuItem.getItemId()) {
                            case R.id.delete:
                                ...
                                alertDialogBuilder.setMessage("Apakah Kamu Ingin Menghapus Data Ini" + kelasModel.getNama_kelas() + " ?");
